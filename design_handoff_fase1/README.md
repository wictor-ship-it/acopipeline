...
- `PROMPT-CORRECAO.md` — prompt para colar quando a implementação divergir do design.
- `design-reference/screens/` — o protótipo v5 fatiado por tela (spec exata, arquivos pequenos; ver `INDEX.md`).
- `design-reference/logic-and-data.js` — lógica + dados de seed extraídos do protótipo.
