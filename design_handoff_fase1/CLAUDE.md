...
**Como usar a referência:** o arquivo completo é grande demais para ler inteiro. Use `design_handoff_fase1/design-reference/screens/` — o protótipo fatiado por tela (`INDEX.md` lista tudo). Antes de implementar ou corrigir QUALQUER tela, leia o fragmento inteiro e copie valores literais dos estilos inline (px, hex, radius, sombras) e o copy exato. Seed e comportamentos: `design-reference/logic-and-data.js`. Nunca implemente uma tela de memória. Se a sessão for compactada/reiniciada, releia este arquivo e o fragmento da tela em andamento.
