...
/* Official multicolor Google mark — the only colored art allowed (README §10).
   Literal SVG from fragment 00 line 32. */
function GoogleMark() {
  return (
...
export function Login() {
  ...
  return (
    <div className="lg-bg">
      {/* loginBgStyle = ambient base gradient, full-screen (fragment/​logic-and-data.js) */}
      ...
      <div className="lg-tagline">“Discretion is equity.”</div>
    </div>
  );
}
