...
async function buildContext() {
  ...
  return {
    ...
    opportunities: opportunities.map((o) => ({ id: o.id, name: o.name, contact_id: o.contact_id, related_contact_ids: o.related_contact_ids, type: o.pipeline, stage: o.stage, closing_stage: o.flow_stage, heat: o.heat, probability: o.probability, budget: o.budget, next_action: o.next_action, next_due: o.next_due, brief: o.agent_context })),
